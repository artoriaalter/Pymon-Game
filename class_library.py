...
class Player:
    ...
    def catch_pymon(self):
        ...
        level_randomizer = random.randint(1, self.current_level + 4)
        ...
        if possibility_randomizer <= 2:
            ...
            if caught_pymon.level <= self.level:
                ...
                print("{type} was able to break out of your ball and escape! You better get stronger!".format(pymon.type))
                self.pyballs -= 1
